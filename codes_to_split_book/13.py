...
INPUT_PDF_FILE = "Kanban Quick Guide.pdf"

# 2. The folder where the chapter PDFs will be saved.
OUTPUT_FOLDER = "data_for_finetuning_kanban"
...
CHAPTERS = {
    "kqg_part1_Kanban_Fundamentals_and_Principles": (1, 4),
    "kqg_part2_Kanban_in_Agile_and_Scrum": (5, 10),
    "kqg_part3_Kanban_Software_Tools_and_Solutions": (11, 17),
}
