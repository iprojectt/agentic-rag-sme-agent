...
INPUT_PDF_FILE = "The 7 Habits of Highly Effective People.pdf"

# 2. The folder where the chapter PDFs will be saved.
OUTPUT_FOLDER = "data_for_finetuning_7_habit"
...
CHAPTERS = {
    "sh_part1_Paradigms_and_Principles": (6, 30),
    "sh_part2_habit1_Be_Proactive": (31, 44),
    "sh_part2_habit2_Begin_with_the_End_in_Mind": (45, 72),
    "sh_part2_habit3_Put_First_Things_First": (73, 90),
    "sh_part3_intro_Public_Victory": (91, 101),
    "sh_part3_habit4_Think_Win-Win": (102, 118),
    "sh_part3_habit5_Seek_First_to_Understand": (119, 133),
    "sh_part3_habit6_Synergize": (134, 146),
    "sh_part4_habit7_Sharpen_the_Saw": (147, 157),
    "sh_conclusion_Inside-Out_Again": (158, 164),
    "sh_appendix_A_and_B": (165, 172),
}
