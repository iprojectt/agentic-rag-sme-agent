...
INPUT_PDF_FILE = "The Time-Block Planner.pdf"

# 2. The folder where the chapter PDFs will be saved.
OUTPUT_FOLDER = "data_for_finetuning_time-block"
...
CHAPTERS = {
    "tbp_part1_Introduction_to_Time_Blocking": (3, 12),
    "tbp_part2_Advanced_Tips_and_Core_Rituals": (13, 18),
    "tbp_part3_Weekly_Planning_and_System_Mastery": (19, 22),
    "tbp_part4_Process_and_Proceed_Quarterly_Review": (29, 31),
}
